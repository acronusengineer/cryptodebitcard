  ...
  _renderCameraComponent() {
    return (
      <Camera
        ...
        flashMode={this.state.isFlashOn ? CAMERA_FLASH_MODE.torch : CAMERA_FLASH_MODE.off}
        captureAudio={false}
  ...
  render() {
    return (
      <View style={styles.mainContainer}>
        <View style={styles.cameraContainerStyle}>{this._renderCamera()}</View>
        <View
          style={{
            position: 'absolute',
            backgroundColor: 'transparent',
            ...
            <Image
              ...
              source={
                this.state.isFlashOn
                  ? require('../../assets/images/flash_on.jpg')
                  : require('../../assets/images/flash_off.jpg')
              }
            />
          </TouchableOpacity>
          <TouchableOpacity
